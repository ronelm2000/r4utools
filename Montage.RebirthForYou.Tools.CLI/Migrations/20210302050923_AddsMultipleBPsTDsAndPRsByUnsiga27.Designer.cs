...
namespace Montage.RebirthForYou.Tools.CLI.Migrations
{
    ...
    [Migration("20210302050923_AddsMultipleBPsTDsAndPRsByUnsiga27")]
    partial class AddsMultipleBPsTDsAndPRsByUnsiga27
    {
            ...
            modelBuilder.Entity("Montage.RebirthForYou.Tools.CLI.Entities.ActivityLog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            LogID = 18,
                            Activity = 0,
                            DateAdded = new DateTime(2020, 1, 2, 0, 0, 10, 0, DateTimeKind.Unspecified),
                            IsDone = false,
